...
;
;
function SummaryPanel({ counts, baseMulta, baseMeses, finalMulta, finalMeses, reuPrimario, reducaoManual, onClear }) {
    ...
    const handleCopy = ()=>{
        ...
        const reductions = [];
        if (reuPrimario) reductions.push("Réu Primário (multa -30% / pena -20%)");
        if (reducaoManual > 0) reductions.push(`Cooperação com oficial (-${reducaoManual}%)`);
        const lines = [
            "📋 BOLETIM DE OCORRÊNCIA — FRONTEIRA RP",
            "═".repeat(40),
            "",
            "CRIMES COMETIDOS:",
            ...selectedCrimes.map((c)=>`  • ${c.name} — ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$crimes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatMulra"])(c.multa)} / ${c.meses} meses`),
            "",
            ...reductions.length > 0 ? [
                "REDUÇÕES APLICADAS:",
                ...reductions.map((r)=>`  ▸ ${r}`),
            ...
            "─".repeat(40),
            `💰 MULTA TOTAL: ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$crimes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatMulra"])(finalMulta)}`,
            `⏳ PRISÃO TOTAL: ${finalMeses} meses`
        ];
...
//# sourceMappingURL=_0jujm0m._.js.map