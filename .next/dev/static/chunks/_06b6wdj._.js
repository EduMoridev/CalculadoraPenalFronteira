...
function SummaryPanel({ counts, baseMulta, baseMeses, finalMulta, finalMeses, reuPrimario, reducaoManual, onClear }) {
    ...
    const handleCopy = ()=>{
        ...
        const lines = [
            ...
            "",
            "CRIMES COMETIDOS:",
            ...selectedCrimes.map((c)=>`  • ${c.name} — ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$crimes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatMulra"])(c.multa)} / ${c.meses} meses`),
            "",
            ...reductions.length > 0 ? [
                "REDUÇÕES APLICADAS:",
                ...reductions.map((r)=>`  ▸ ${r}`),
            ...
            "─".repeat(40),
            `💰 MULTA TOTAL: ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$crimes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatMulra"])(finalMulta)}`,
...
//# sourceMappingURL=_06b6wdj._.js.map